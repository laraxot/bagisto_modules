...
class ContentController extends Controller
{
    ...
    */
     ...
     *
     * @var \Modules\myTestTheme\Repositories\ContentRepository
    */
     ...
     * @param  \Modules\myTestTheme\Repositories\ContentRepository  $contentRepository
     * @return void
     */
    ...
    */
    ...
    public function store()
    {
        ...
        session()->flash('success', trans('admin::app.response.create-success', ['name' => trans('myTestTheme::app.admin.layouts.header-content')]));
    ...
    public function update($id)
    {
        ...
        session()->flash('success', trans('admin::app.response.update-success', ['name' => trans('myTestTheme::app.admin.layouts.header-content')]));
    ...
    public function massDestroy()
    {
        ...
        session()->flash('success', trans('myTestTheme::app.admin.contents.mass-delete-success'));
