...
class CategoryDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        ...
        $queryBuilder = DB::table('my_test_theme_category as v_cat')
    ...
    public function addColumns()
    {
        $this->addColumn([
            'index'      => 'category_id',
            'label'      => trans('myTestTheme::app.admin.category.datagrid.category-id'),
            'type'       => 'number',
            'searchable' => true,
            'sortable'   => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'name',
            'label'      => trans('myTestTheme::app.admin.category.datagrid.category-name'),
            'type'       => 'string',
            'searchable' => true,
            'sortable'   => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'icon',
            'label'      => trans('myTestTheme::app.admin.category.datagrid.category-icon'),
            'type'       => 'string',
            'sortable'   => true,
            'searchable' => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'status',
            'label'      => trans('myTestTheme::app.admin.category.datagrid.category-status'),
            'type'       => 'string',
            'sortable'   => true,
            'searchable' => true,
            'filterable' => true,
    ...
    public function prepareActions() {
        $this->addAction([
            'type'   => 'Edit',
            'method' => 'GET',
            'route'  => 'myTestTheme.admin.category.edit',
        ...
        $this->addAction([
            'type'         => 'Delete',
            'method'       => 'POST',
            'route'        => 'myTestTheme.admin.category.delete',
    ...
    public function prepareMassActions()
    {
        $this->addMassAction([
            'type'   => 'delete',
            'action' => route('myTestTheme.admin.category.mass-delete'),
