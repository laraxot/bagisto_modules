...
namespace Modules\MyTestTheme\DataGrids;
...
class ContentDataGrid extends DataGrid
{
    ...
    {
        $queryBuilder = DB::table('myTestTheme_contents as con')
            ->select('con.id as content_id', 'con_trans.title', 'con.position', 'con.content_type', 'con.status')
            ->leftJoin('myTestTheme_contents_translations as con_trans', function($leftJoin) {
    ...
    public function addColumns()
    {
        $this->addColumn([
            'index'      => 'content_id',
            'label'      => trans('myTestTheme::app.admin.contents.datagrid.id'),
            'type'       => 'number',
            'searchable' => true,
            'sortable'   => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'title',
            'label'      => trans('myTestTheme::app.admin.contents.datagrid.title'),
            'type'       => 'string',
            'searchable' => true,
            'sortable'   => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'position',
            'label'      => trans('myTestTheme::app.admin.contents.datagrid.position'),
            'type'       => 'number',
            'searchable' => true,
            'sortable'   => true,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'status',
            'label'      => trans('myTestTheme::app.admin.contents.datagrid.status'),
            'type'       => 'boolean',
            'sortable'   => true,
            'searchable' => false,
            'filterable' => true,
        ...
        $this->addColumn([
            'index'      => 'content_type',
            'label'      => trans('myTestTheme::app.admin.contents.datagrid.content-type'),
            'type'       => 'string',
            'sortable'   => true,
            'searchable' => true,
            'filterable' => false,
    ...
    public function prepareMassActions()
    {
        $this->addMassAction([
            'type'   => 'delete',
            'action' => route('myTestTheme.admin.content.mass-delete'),
