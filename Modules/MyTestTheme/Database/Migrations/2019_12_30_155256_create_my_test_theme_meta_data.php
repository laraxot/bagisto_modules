...
class CreateMyTestThemeMetaData extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('my_test_theme_meta_data', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('my_test_theme_meta_data');
    }
}
