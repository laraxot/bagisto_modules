    ...
    <script type="text/x-template" id="cart-btn-template">
        <button
            ...
            <div class="mini-cart-content">
                ...
                <span class="fs18 fw6 cart-text">{{ __('myTestTheme::app.minicart.cart') }}</span>
            </div>
...
@push('scripts')
    <script type="text/x-template" id="logo-template">
        <a
            ...
            @else
                <img class="logo" src="{{ asset('themes/myTestTheme/assets/images/logo-text.png') }}" alt="" width="200" height="50" />
            @endif
        </a>
    </script>
                ...
                <div class="col-lg-5 col-md-12">
                    <div class="input-group">
                        <form
                            ...
                            role="search"
                            id="search-form"
                            action="{{ route('myTestTheme.search.index') }}">
                                ...
                                <div class="btn-group full-width force-center">
                                    <div class="selectdiv">
                                        <select class="form-control fs13 styled-select" name="category" @change="focusInput($event)" aria-label="Category">
                                            <option value="">
                                                {{ __('myTestTheme::app.header.all-categories') }}
                                            </option>
                                    ...
                                    <input
                                        ...
                                        type="search"
                                        class="form-control"
                                        placeholder="{{ __('myTestTheme::app.header.search-text') }}"
                                        aria-label="Search"
                        ...
                        {!! view_render_event('bagisto.shop.layout.header.compare.before') !!}
                            @if ($showCompare)
                                <a
                                    ...
                                    <span>{{ __('myTestTheme::app.customer.compare.text') }}</span>
                                </a>
                            @endif
