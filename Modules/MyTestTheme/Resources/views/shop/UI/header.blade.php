@push('scripts')
    <script type="text/x-template" id="content-header-template">
        <header class="row myTestTheme-divide-page vc-header header-shadow active">
                    ...
                    <div class="col-6">
                        <div v-if="hamburger" class="nav-container scrollable">
                            <div class="wrapper" v-if="this.rootCategories">
                                <div class="greeting drawer-section fw6">
                                    ...
                                    <span>
                                        @guest('customer')
                                            ...
                                            {{ __('myTestTheme::app.responsive.header.greeting', ['customer' => 'Guest']) }}
                                            </a>
                                        @endguest

                                        @auth('customer')
                                            <a class="unset" href="{{ route('customer.profile.index') }}">
                                                {{ __('myTestTheme::app.responsive.header.greeting', ['customer' => auth()->guard('customer')->user()->first_name]) }}
                                            </a>
                                        @endauth
                                ...
                                <ul type="none" class="myTestTheme-content" v-if="headerContent.length > 0">
                                    ...
                                    <ul type="none" class="vc-customer-options">
                                        ...
                                        <li>
                                            <a href="{{ route('customer.address.index') }}" class="unset">
                                                ...
                                                <span>{{ __('myTestTheme::app.shop.general.addresses') }}</span>
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="{{ route('customer.reviews.index') }}" class="unset">
                                                ...
                                                <span>{{ __('myTestTheme::app.shop.general.reviews') }}</span>
                                            </a>
                                        </li>
                                        ...
                                        @if (core()->getConfigData('general.content.shop.compare_option'))
                                            <li>
                                                <a href="{{ route('myTestTheme.customer.product.compare') }}" class="unset">
                                        ...
                                        <li>
                                            <a href="{{ route('customer.orders.index') }}" class="unset">
                                                ...
                                                <span>{{ __('myTestTheme::app.shop.general.orders') }}</span>
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="{{ route('customer.downloadable_products.index') }}" class="unset">
                                                ...
                                                <span>{{ __('myTestTheme::app.shop.general.downloadables') }}</span>
                                            </a>
                                        </li>
                                    </ul>
                                @endauth
                                        ...
                                        @if ($locale)
                                            <div class="language-logo-wrapper">
                                                ...
                                                @elseif ($locale->code == "en")
                                                    <img
                                                        class="language-logo"
                                                        src="{{ asset('/themes/myTestTheme/assets/images/flags/en.png') }}" alt="" />
                                                @endif
                                            </div>
                            ...
                            <div class="wrapper" v-else-if="languages">
                                <div class="drawer-section">
                                    ...
                                    <h4 class="display-inbl">{{ __('myTestTheme::app.responsive.header.languages') }}</h4>
                                            ...
                                            <a
                                                ...
                                                @if( $locale->code == 'en')
                                                    <div class="category-logo">
                                                        <img
                                                        class="category-icon"
                                                        src="{{ asset('/themes/myTestTheme/assets/images/flags/en.png') }}" alt="" width="20" height="20" />
                                                    </div>
                                                @else
                            ...
                            <div class="wrapper" v-else-if="currencies">
                                <div class="drawer-section">
                                    ...
                                    <h4 class="display-inbl">{{ __('myTestTheme::app.shop.general.currencies') }}</h4>
                                    <i class="material-icons float-right text-dark" @click="closeDrawer()">cancel</i>
                                </div>
                    ...
                    <div class="right-vc-header col-6">
                        @if ($showCompare)
                            <a
                                ...
                                @auth('customer')
                                    href="{{ route('myTestTheme.customer.product.compare') }}"
                                @endauth

                                @guest('customer')
                                    href="{{ route('myTestTheme.product.compare') }}"
                                @endguest
                                >
