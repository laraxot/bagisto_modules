@inject ('wishListHelper', 'Modules\Customer\Helpers\Wishlist')
...
{!! view_render_event('bagisto.shop.products.wishlist.before') !!}
    ...
    @auth('customer')
        @php
            ...
            /* title */
            $title = $wishlist ? __('myTestTheme::app.shop.wishlist.remove-wishlist-text') : __('myTestTheme::app.shop.wishlist.add-wishlist-text');
        @endphp
    ...
    @guest('customer')
        <a
            ...
            title="{{ __('myTestTheme::app.shop.wishlist.add-wishlist-text') }}">
