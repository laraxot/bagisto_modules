...
@inject ('reviewHelper', 'Modules\Product\Helpers\Review')
@inject ('customHelper', 'Modules\myTestTheme\Helpers\Helper')
...
@section('seo')
    ...
    @if (core()->getConfigData('catalog.rich_snippets.products.enable'))
        <script type="application/ld+json">
            {!! app('Modules\Product\Helpers\SEO')->getProductJsonLd($product) !!}
        </script>
    @endif
    ...
    {!! view_render_event('bagisto.shop.products.view.before', ['product' => $product]) !!}
        <div class="row no-margin">
                                ...
                                <div class="right col-lg-7 col-md-6">
                                    ...
                                    @if ($product->short_description)
                                        <div class="description">
                                            <h3 class="col-lg-12">{{ __('myTestTheme::app.products.short-description') }}</h3>
            ...
            <div class="store-meta-images col-3">
                @if(
                    isset($myTestThemeMetaData['product_view_images'])
                    && $myTestThemeMetaData['product_view_images']
                )
                    @foreach (json_decode($myTestThemeMetaData['product_view_images'], true) as $image)
                        @if ($image && $image !== '')
