...
@inject ('productRepository', 'Modules\Product\Repositories\ProductRepository')
...
@section('seo')
    ...
    @if (core()->getConfigData('catalog.rich_snippets.categories.enable'))
        <script type="application/ld+json">
            {!! app('Modules\Product\Helpers\SEO')->getCategoryJsonLd($category) !!}
        </script>
    @endif
@stop
...
@push('scripts')
    <script type="text/x-template" id="category-template">
        <section class="row col-12 myTestTheme-divide-page category-page-wrapper">
