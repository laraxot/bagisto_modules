...
@inject ('toolbarHelper', 'Modules\Product\Helpers\Toolbar')
...
@php
    ...
    $product->__set('firstReviewText', trans('myTestTheme::app.products.be-first-review'));
                ...
                @if ($totalReviews)
                    <div class="product-rating col-12 no-padding">
                        ...
                        <span class="align-top">
                            {{ __('myTestTheme::app.products.ratings', ['totalRatings' => $totalReviews ]) }}
                        </span>
                    </div>
                @else
                    <div class="product-rating col-12 no-padding">
                        <span class="fs14">{{ __('myTestTheme::app.products.be-first-review') }}</span>
                    </div>
                @endif
