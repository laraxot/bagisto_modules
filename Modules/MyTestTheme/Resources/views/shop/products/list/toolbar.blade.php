        ...
        <div class="toolbar-wrapper row col-12 remove-padding-margin" v-else>
            <div
                ...
                <div class="header drawer-section">
                    ...
                    <span class="fs24 fw6">
                        {{ __('myTestTheme::app.shop.general.filter') }}
                    </span>
                    <span class="float-right link-color" @click="toggleLayeredNavigation">
                        {{ __('myTestTheme::app.responsive.header.done') }}
                    </span>
                </div>

                @if (request()->route()->getName() != 'myTestTheme.search.index')
            ...
            <div class="col-4" @click="toggleLayeredNavigation({event: $event, actionType: 'open'})">
                <a class="unset">
                    ...
                    <span>{{ __('myTestTheme::app.shop.general.filter') }}</span>
                </a>
            </div>
            ...
            <div class="col-4">
                ...
                <a
                    ...
                    <span>{{ __('myTestTheme::app.shop.general.view') }}</span>
                </a>
            </div>
        </div>
    </script>
