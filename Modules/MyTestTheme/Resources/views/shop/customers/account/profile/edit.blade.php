...
@section('page-detail-wrapper')
    ...
    <form
        ...
        <div class="account-table-content">
                    ...
                    <select
                        ...
                        <option
                            ...
                            @if ($customer->gender == "Other")
                                selected="selected"
                            @endif>
                            {{ __('myTestTheme::app.shop.gender.other') }}
                        </option>
                        ...
                        <option
                            ...
                            @if ($customer->gender == "Male")
                                selected="selected"
                            @endif>
                            {{ __('myTestTheme::app.shop.gender.male') }}
                        </option>
                        ...
                        <option
                            ...
                            @if ($customer->gender == "Female")
                                selected="selected"
                            @endif>
                            {{ __('myTestTheme::app.shop.gender.female') }}
                        </option>
                    </select>
            ...
            <div class="row">
                <label class="col-12">
                    {{ __('myTestTheme::app.shop.general.enter-current-password') }}
                </label>
            ...
            <div class="row">
                <label class="col-12">
                    {{ __('myTestTheme::app.shop.general.new-password') }}
                </label>
            ...
            <div class="row">
                <label class="col-12">
                    {{ __('myTestTheme::app.shop.general.confirm-new-password') }}
                </label>
            ...
            <button
                ...
                {{ __('myTestTheme::app.shop.general.update') }}
            </button>
        </div>
    </form>
