    ...
    <div class="auth-content form-container">
        <div class="container">
            <div class="col-lg-10 col-md-12 offset-lg-1">
                <div class="heading">
                    <h2 class="fs24 fw6">
                        {{ __('myTestTheme::app.customer.forget-password.forgot-password')}}
                    </h2>

                    <a href="{{ route('customer.session.index') }}" class="btn-new-customer">
                        <button type="button" class="theme-btn light">
                            {{  __('myTestTheme::app.customer.signup-form.login') }}
                        </button>
                    </a>
                </div>
                ...
                <div class="body col-12">
                    <h3 class="fw6">
                        {{ __('myTestTheme::app.customer.forget-password.recover-password')}}
                    </h3>

                    <p class="fs16">
                        {{ __('myTestTheme::app.customer.forget-password.recover-password-text')}}
                    </p>
