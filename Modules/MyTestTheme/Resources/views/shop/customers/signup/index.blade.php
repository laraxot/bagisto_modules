    ...
    <div class="auth-content form-container">
        <div class="container">
            <div class="col-lg-10 col-md-12 offset-lg-1">
                <div class="heading">
                    <h2 class="fs24 fw6">
                        {{ __('myTestTheme::app.customer.signup-form.user-registration')}}
                    </h2>
                ...
                <div class="body col-12">
                    <h3 class="fw6">
                        {{ __('myTestTheme::app.customer.signup-form.become-user')}}
                    </h3>

                    <p class="fs16">
                        {{ __('myTestTheme::app.customer.signup-form.form-sginup-text')}}
                    </p>
