        ...
        {!! view_render_event('bagisto.shop.customers.login.before') !!}
            ...
            <div class="container">
                <div class="col-lg-10 col-md-12 offset-lg-1">
                    <div class="heading">
                        <h2 class="fs24 fw6">
                            {{ __('myTestTheme::app.customer.login-form.customer-login')}}
                        </h2>

                        <a href="{{ route('customer.register.index') }}" class="btn-new-customer">
                            <button type="button" class="theme-btn light">
                                {{ __('myTestTheme::app.customer.login-form.sign-up')}}
                            </button>
                        </a>
                    </div>
                    ...
                    <div class="body col-12">
                        <div class="form-header">
                            <h3 class="fw6">
                                {{ __('myTestTheme::app.customer.login-form.registered-user')}}
                            </h3>

                            <p class="fs16">
                                {{ __('myTestTheme::app.customer.login-form.form-login-text')}}
                            </p>
                        </div>
