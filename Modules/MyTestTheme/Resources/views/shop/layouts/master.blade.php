...
<html lang="{{ app()->getLocale() }}">
    ...
    <head>
        ...
        @else
            <link rel="icon" sizes="16x16" href="{{ asset('/themes/myTestTheme/assets/images/static/v-icon.png') }}" />
        @endif
            ...
            <div class="main-container-wrapper">
                ...
                @section('body-header')
                    ...
                    <div class="main-content-wrapper col-12 no-padding">
                        @php
                            $myTestThemeContent = app('Modules\myTestTheme\Repositories\ContentRepository')->getAllContents();
                        @endphp

                        <content-header
                            url="{{ url()->to('/') }}"
                            :header-content="{{ json_encode($myTestThemeContent) }}"
                            heading= "{{ __('myTestTheme::app.menu-navbar.text-category') }}"
                            category-count="{{ $myTestThemeMetaData ? $myTestThemeMetaData->sidebar_category_count : 10 }}"
                        ></content-header>
