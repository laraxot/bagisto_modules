            ...
            <div id="account">
                <div class="d-inline-block welcome-content" @click="togglePopup">
                    ...
                    <span class="text-center">
                        @guest('customer')
                            {{ __('myTestTheme::app.header.welcome-message', ['customer_name' => trans('myTestTheme::app.header.guest')]) }}!
                        @endguest

                        @auth('customer')
                            {{ __('myTestTheme::app.header.welcome-message', ['customer_name' => auth()->guard('customer')->user()->first_name]) }}
                        @endauth
                    </span>
                ...
                @auth('customer')
                    <div class="modal-content customer-options">
                        ...
                        <ul type="none">
                            ...
                            <li>
                                <a href="{{ route('customer.orders.index') }}" class="unset">{{ __('myTestTheme::app.shop.general.orders') }}</a>
                            </li>
                            ...
                            @if ($showCompare)
                                <li>
                                    <a href="{{ route('myTestTheme.customer.product.compare') }}" class="unset">{{ __('myTestTheme::app.customer.compare.text') }}</a>
                                </li>
                            @endif
