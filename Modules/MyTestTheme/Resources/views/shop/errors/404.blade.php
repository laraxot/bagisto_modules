    ...
    <div class="error-page row text-center">
        <div class="col-6">
            ...
            <div class="col-12 fs24">
                {{ __('myTestTheme::app.error.page-lost-short') }}
            </div>

            <p class="col-12 fs20">
                {{ __('myTestTheme::app.error.page-lost-description') }}
            </p>
        </div>
        ...
        <div class="col-6">
            <div class="row">
                ...
                @if ($logo = core()->getCurrentChannel()->logo_url)
                    <div
                        class="col-12 myTestTheme-icon bg-image"
                        style="background-image: url('{{ $logo }}')"
                    ></div>
                @else
                    <div class="col-12 myTestTheme-icon bg-image"></div>
                @endif
            </div>
            ...
            <a class="row remove-decoration" href="{{ route('shop.home.index') }}">
                ...
                <span class="col-12 fs16">
                    {{ __('myTestTheme::app.error.go-to-home') }}
                </span>
            </a>
        </div>
    </div>
