<div class="order-summary fs16">
    <h3 class="fw6">{{ __('myTestTheme::app.checkout.cart.cart-summary') }}</h3>

    <div class="row">
        <span class="col-8">{{ __('myTestTheme::app.checkout.sub-total') }}</span>
    ...
    @if ($cart->base_tax_total)
        @foreach (Modules\Tax\Helpers\Tax::getTaxRatesWithAmount($cart, true) as $taxRate => $baseTaxAmount )
            <div class="row">
    ...
    <div class="row">
        ...
        <proceed-to-checkout
            ...
            text="{{ __('myTestTheme::app.checkout.proceed') }}"
