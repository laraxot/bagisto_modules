@php
    $reviews = app('Modules\myTestTheme\Helpers\Helper')->getShopRecentReviews(4);
...
<div class="container-fluid reviews-container">
    @if ($reviewCount)
        <card-list-header
            heading="{{ __('myTestTheme::app.home.customer-reviews') }}"
        ></card-list-header>
                            ...
                            <div class="customer-info">
                                ...
                                <div>
                                    ...
                                    <div class="product-info fs16">
                                        <span>{{ __('myTestTheme::app.products.reviewed') }}- <a class="remove-decoration link-color" href="{{ route('shop.productOrCategory.index', $review->product->url_key) }}">{{$review->product->name}}</a></span>
                                    </div>
                                </div>
                            </div>
