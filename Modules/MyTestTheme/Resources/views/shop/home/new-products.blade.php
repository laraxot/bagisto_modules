...
<product-collections
    ...
    product-route="{{ route('myTestTheme.category.details', ['category-slug' => 'new-products', 'count' => $count]) }}"
    locale-direction="{{ $direction }}"
    show-recently-viewed="{{ (Boolean) $showRecentlyViewed }}"
    recently-viewed-title="{{ __('myTestTheme::app.products.recently-viewed') }}"
