...
@if (! $isRendered)
    <div class="container-fluid advertisement-three-container">
        <div class="row">
            <a @if (isset($one)) href="{{ $one }}" @endif class="col-lg-6 col-md-12 no-padding">
                <img data-src="{{ asset('/themes/myTestTheme/assets/images/headphones.webp') }}" class="full-width lazyload" alt="" />
            </a>

            <div class="col-lg-6 col-md-12 second-panel">
                <a @if (isset($two)) href="{{ $two }}" @endif class="row top-container">
                    <img data-src="{{ asset('/themes/myTestTheme/assets/images/watch.webp') }}" class="col-12 pr0 lazyload" alt="" />
                </a>
                <a @if (isset($three)) href="{{ $three }}" @endif class="row bottom-container">
                    <img data-src="{{ asset('/themes/myTestTheme/assets/images/kids-2.webp') }}" class="col-12 pr0 lazyload" alt="" />
                </a>
            </div>
        </div>
    </div>
