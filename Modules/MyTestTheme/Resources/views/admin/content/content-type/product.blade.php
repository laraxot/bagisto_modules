    ...
    <script type="text/x-template" id="catalog-product-template">
        <div>
            <div class="control-group" :class="[errors.has('catalog_type') ? 'has-error' : '']">
                ...
                <select class="control" v-validate="'required'" id="catalog_type" name="catalog_type" v-model="catalog_type" data-vv-as="&quot;{{ __('myTestTheme::app.admin.contents.content.catalog-type') }}&quot;" @change="loadCatalogType($event)">
            ...
            <div v-if="catalog_type == 'custom'">
                <field-autocomplete
                    ...
                    {{-- :linkedResults="@json(app('Modules\CustomerGroup\Repositories\CustomerGroupRepository')->getProducts(1))" --}}
                ></field-autocomplete>
            </div>
        </div>
