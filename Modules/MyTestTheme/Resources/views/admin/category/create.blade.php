...
@section('page_title')
    {{ __('myTestTheme::app.admin.category.add-title') }}
@stop
                    ...
                    <div slot="body">
                        ...
                        {!! view_render_event('bagisto.admin.category.create_form_accordian.general.content.before') !!}
                            ...
                            <div class="control-group" :class="[errors.has('category_id') ? 'has-error' : '']">
                                ...
                                <select v-validate="'required'" class="control" id="category_id" name="category_id" data-vv-as="&quot;{{ __('myTestTheme::app.admin.category.select-category') }}&quot;">
                            ...
                            <div class="control-group" :class="[errors.has('icon') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="icon" name="icon" data-vv-as="&quot;{{ __('myTestTheme::app.admin.category.icon-class') }}&quot;" />
                            ...
                            <div class="control-group" :class="[errors.has('tooltip') ? 'has-error' : '']">
                                ...
                                <textarea v-validate="'max:250'" class="control" id="tooltip" name="tooltip" data-vv-as="&quot;{{ __('myTestTheme::app.admin.category.tooltip-content') }}&quot;"></textarea>
