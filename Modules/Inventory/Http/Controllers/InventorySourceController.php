...
class InventorySourceController extends Controller
{
    ...
    public function store()
    {
        $this->validate(request(), [
            'code'           => ['required', 'unique:inventory_sources,code', new \Modules\Core\Contracts\Validations\Code],
            'name'           => 'required',
    ...
    {
        $this->validate(request(), [
            'code'           => ['required', 'unique:inventory_sources,code,' . $id, new \Modules\Core\Contracts\Validations\Code],
            'name'           => 'required',
            'contact_name'   => 'required',
            'contact_email'  => 'required|email',
            'contact_number' => 'required',
