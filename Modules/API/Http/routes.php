...
Route::group(['prefix' => 'api'], function ($router) {
    ...
    Route::group(['namespace' => 'Modules\API\Http\Controllers\Shop', 'middleware' => ['locale', 'theme', 'currency']], function ($router) {
        ...
        Route::get('categories', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Category\Repositories\CategoryRepository',
            'resource' => 'Modules\API\Http\Resources\Catalog\Category'
        ]);
        ...
        Route::get('attributes', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Attribute\Repositories\AttributeRepository',
            'resource' => 'Modules\API\Http\Resources\Catalog\Attribute'
        ]);
        ...
        Route::get('families', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Attribute\Repositories\AttributeFamilyRepository',
            'resource' => 'Modules\API\Http\Resources\Catalog\AttributeFamily'
        ]);
        ...
        Route::get('reviews', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Product\Repositories\ProductReviewRepository',
            'resource' => 'Modules\API\Http\Resources\Catalog\ProductReview'
        ]);
        ...
        Route::get('channels', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Core\Repositories\ChannelRepository',
            'resource' => 'Modules\API\Http\Resources\Core\Channel'
        ]);
        ...
        Route::get('locales', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Core\Repositories\LocaleRepository',
            'resource' => 'Modules\API\Http\Resources\Core\Locale'
        ]);
        ...
        Route::get('countries', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Core\Repositories\CountryRepository',
            'resource' => 'Modules\API\Http\Resources\Core\Country'
        ]);
        ...
        Route::get('sliders', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Core\Repositories\SliderRepository',
            'resource' => 'Modules\API\Http\Resources\Core\Slider'
        ]);
        ...
        Route::get('currencies', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Core\Repositories\CurrencyRepository',
            'resource' => 'Modules\API\Http\Resources\Core\Currency'
        ]);
        ...
        Route::get('customers/{id}', 'CustomerController@get')->defaults('_config', [
            'repository' => 'Modules\Customer\Repositories\CustomerRepository',
            'resource' => 'Modules\API\Http\Resources\Customer\Customer',
            'authorization_required' => true
        ]);
        ...
        Route::get('addresses/{id}', 'ResourceController@get')->defaults('_config', [
            'repository' => 'Modules\Customer\Repositories\CustomerAddressRepository',
            'resource' => 'Modules\API\Http\Resources\Customer\CustomerAddress',
            'authorization_required' => true
        ]);
        ...
        Route::get('orders', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Sales\Repositories\OrderRepository',
            'resource' => 'Modules\API\Http\Resources\Sales\Order',
            'authorization_required' => true
        ]);
        ...
        Route::get('invoices', 'InvoiceController@index')->defaults('_config', [
            'repository' => 'Modules\Sales\Repositories\InvoiceRepository',
            'resource' => 'Modules\API\Http\Resources\Sales\Invoice',
            'authorization_required' => true
        ]);
        ...
        Route::get('shipments', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Sales\Repositories\ShipmentRepository',
            'resource' => 'Modules\API\Http\Resources\Sales\Shipment',
            'authorization_required' => true
        ]);
        ...
        Route::get('wishlist', 'ResourceController@index')->defaults('_config', [
            'repository' => 'Modules\Customer\Repositories\WishlistRepository',
            'resource' => 'Modules\API\Http\Resources\Customer\Wishlist',
            'authorization_required' => true
        ]);
