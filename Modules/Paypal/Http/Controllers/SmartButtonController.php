...
use Modules\Paypal\Payment\SmartButton;
...
class SmartButtonController extends Controller
{
     ...
     *
     * @var \Modules\Paypal\Payment\SmartButton
     */
     ...
     *
     * @param  \Modules\Paypal\Payment\SmartButton  $smartButton
     * @param  \Modules\Attribute\Repositories\OrderRepository  $orderRepository
     * @param  \Modules\Sales\Repositories\InvoiceRepository  $invoiceRepository
     * @return void
     */
     ...
     *
     * @param  \Modules\Sales\Models\Order  $order
     * @return array
     */
