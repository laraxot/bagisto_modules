...
/** @var \Modules\CartRule\Models\CartRule $cartRule */
?>
...
@push('scripts')
    ...
    <script type="text/x-template" id="create-coupon-form-template">
        <div class="">
            ...
            @inject('cartRuleCouponGrid','Modules\Admin\DataGrids\CartRuleCouponDataGrid')
...
@endpush
    ...
    <script>
        ...
        Vue.component('cart-rule-condition-item', {
            ...
            data: function() {
                return {
                    condition_attributes: @json(app('\Modules\CartRule\Repositories\CartRuleRepository')->getConditionAttributes()),
