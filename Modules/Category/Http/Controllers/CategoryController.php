...
class CategoryController extends Controller
{
    ...
    public function store()
    {
        $this->validate(request(), [
            'slug'        => ['required', 'unique:category_translations,slug', new \Modules\Core\Contracts\Validations\Slug],
            'name'        => 'required',
    ...
    public function update($id)
    {
        ...
        $this->validate(request(), [
            $locale . '.slug' => ['required', new \Modules\Core\Contracts\Validations\Slug, function ($attribute, $value, $fail) use ($id) {
