@inject ('attributeRepository', 'Modules\Attribute\Repositories\AttributeRepository')

@inject ('productFlatRepository', 'Modules\Product\Repositories\ProductFlatRepository')
