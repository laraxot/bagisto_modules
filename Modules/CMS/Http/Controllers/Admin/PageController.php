 ...
 class PageController extends Controller
{
    ...
    public function store()
    {
        ...
        $this->validate(request(), [
            'url_key'      => ['required', 'unique:cms_page_translations,url_key', new \Modules\Core\Contracts\Validations\Slug],
            'page_title'   => 'required',
            'channels'     => 'required',
    ...
    public function update($id)
    {
        ...
        $this->validate(request(), [
            $locale . '.url_key'      => ['required', new \Modules\Core\Contracts\Validations\Slug, function ($attribute, $value, $fail) use ($id) {
