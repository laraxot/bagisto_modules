...
class Validator
{
    ...
    public function validate($rule, $entity)
    {
        ...
        foreach ($rule->conditions as $condition) {
            ...
            if ($entity instanceof \Modules\Checkout\Contracts\Cart && strpos($condition['attribute'], 'cart|') === false) {
                continue;
            }
    ...
    public function getAttributeValue($condition, $entity)
    {
        ...
        switch (current($chunks)) {
            case 'cart':
                $cart = $entity instanceof \Modules\Checkout\Contracts\Cart ? $entity : $entity->cart;
