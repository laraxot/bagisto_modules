...
namespace Modules\Velocity\Http\Controllers\Admin;
...
class ConfigurationController extends Controller
{
     ...
     *
     * @param  \Modules\Velocity\Repositories\MetadataRepository  $velocityMetaDataRepository
     * @return void
     */
    public function __construct (VelocityMetadataRepository $velocityMetadataRepository)
    {
        ...
        $this->velocityHelper = app('Modules\Velocity\Helpers\Helper');
