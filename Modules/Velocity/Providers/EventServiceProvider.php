...
class EventServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        ], 'Modules\Velocity\Helpers\AdminHelper@saveLocaleImg');

        Event::listen([
            'catalog.category.create.after',
            'catalog.category.update.after',
        ], 'Modules\Velocity\Helpers\AdminHelper@storeCategoryIcon');

        Event::listen([
            'core.settings.slider.create.after',
            'core.settings.slider.update.after',
        ], 'Modules\Velocity\Helpers\AdminHelper@storeSliderDetails');

        Event::listen('checkout.order.save.after', 'Modules\Velocity\Helpers\Helper@topBrand');
    }
}
