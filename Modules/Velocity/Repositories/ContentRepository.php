...
class ContentRepository extends Repository
{
    ...
    */
    ...
    function model()
    {
        return 'Modules\Velocity\Contracts\Content';
    }

    /**
     * @param  array  $data
     * @return \Modules\Velocity\Models\Content
     */
    ...
    public function getAllContents()
    {
        ...
        $velocityMetaData = app('Modules\Velocity\Helpers\Helper')->getVelocityMetaData();
