...
use Modules\Customer\Contracts\CartItem;
...
class Configurable extends AbstractType
{
    ...
    public function getOfferPrice() {
        ...
        foreach ($this->product->variants as $variant) {
            $rulePrice = app('Modules\CatalogRule\Helpers\CatalogRuleProductPrice')->getRulePrice($variant);
    ...
    {
        $childProduct = app('Modules\Product\Repositories\ProductRepository')->findOneByField('id', $data['selected_configurable_option']);
    ...
    public function getBaseImage($item)
    {
        if ($item instanceof \Modules\Customer\Contracts\Wishlist) {
            ...
            if ($item instanceof \Modules\Customer\Contracts\CartItem) {
    ...
    {
        $configurableOption = app('Modules\Product\Helpers\ConfigurableOption');
