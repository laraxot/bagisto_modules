...
abstract class AbstractType
{
     ...
     *
     * @var \Modules\Product\Repositories\productVideoRepository
     */
    ...
    public function haveSpecialPrice($qty = null)
    {
        ...
        $rulePrice = app('Modules\CatalogRule\Helpers\CatalogRuleProductPrice')->getRulePrice($this->product);
    ...
    public function getCustomerGroupPricingOffers() {
        ...
        if (Cart::getCurrentCustomer()->check()) {
            ...
            $customerGroupRepository = app('Modules\Customer\Repositories\CustomerGroupRepository');
