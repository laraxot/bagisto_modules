...
class Bundle extends AbstractType
{
     ...
     *
     * @var \Modules\Product\Repositories\ProductBundleOptionRepository
     */
     ...
     *
     * @var \Modules\Product\Repositories\ProductBundleOptionProductRepository
     */
     ...
     *
     * @var \Modules\Product\Helpers\BundleOption
    */
     ...
     * @param  \Modules\Product\Repositories\ProductBundleOptionRepository  $productBundleOptionRepository
     * @param  \Modules\Product\Repositories\ProductBundleOptionProductRepository  $productBundleOptionProductRepository
     * @param  \Modules\Product\Helpers\BundleOption  $bundleOptionHelper
     ...
     * Get product regular minimal price
     *
     * @param  \Modules\Product\Contracts\ProductBundleOption  $option
     * @param  bool  $minPrice
     * @return float
     */
    ...
    {
        $bundleOption = app('Modules\Product\Helpers\BundleOption');
