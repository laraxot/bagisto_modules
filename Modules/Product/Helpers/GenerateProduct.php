...
class GenerateProduct
{
     ...
     * 
     * @var \Modules\Product\Repositories\AttributeFamilyRepository
     */
     ...
     *
     * @param  \Modules\Product\Repositories\ProductRepository  $productImage
     * @param  \Modules\Product\Repositories\AttributeFamilyRepository  $productImage
     * @return void
     */
    ...
    public function generateDemoBrand()
    {
        ...
        if (! AttributeOption::where(['attribute_id' => $brand->id])->exists()) {
            ...
            AttributeOption::create([
                'admin_name'   => 'Modules Demo Brand (c) 2020',
