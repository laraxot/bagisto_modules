...
class ProductFlat
{
     ...
     * Attribute Object
     *
     * @var \Modules\Attribute\Contracts\Attribute
     */
    protected $attribute;
     ...
     * @param  \Modules\Product\Repositories\ProductFlatRepository  $productFlatRepository
     ...
     *
     * @param  \Modules\Product\Contracts\Product  $product
     * @param  \Modules\Product\Contracts\Product  $parentProduct
     * @return void
     */
    public function createFlat($product, $parentProduct = null)
    {
        ...
        if (isset($product['channels'])) {
            foreach ($product['channels'] as $channel) {
                $channel = app('Modules\Core\Repositories\ChannelRepository')->findOrFail($channel);
