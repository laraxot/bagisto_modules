    ...
    */
    ...
    public function getProductsRelatedFilterableAttributes($category)
    {
        ...
        if ($productsCount > 0) {
            ...
            $attributes = app('Modules\Attribute\Repositories\AttributeRepository')->getModel()::with(['options' => function($query) use ($productCategoryArrributes) {
     ...
     *
     * @param \Modules\Attribute\Models\Attribute $attribute
     * @param \Modules\Product\Listeners\ProductFlat $listener
     */
    public function updateAttributeColumn(
        \Modules\Attribute\Models\Attribute $attribute ,
        \Modules\Product\Listeners\ProductFlat $listener ) {
        return $this->model
