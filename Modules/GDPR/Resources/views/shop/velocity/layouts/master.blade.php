@php
    $velocityHelper = app('Modules\Velocity\Helpers\Helper');
    ...
    <body @if (core()->getCurrentLocale()->direction == 'rtl') class="rtl" @endif>
            ...
            <div class="main-container-wrapper">
                ...
                @section('body-header')
                    ...
                    <div class="main-content-wrapper col-12 no-padding">
                        @php
                            $velocityContent = app('Modules\Velocity\Repositories\ContentRepository')->getAllContents();
                        @endphp
        ...
        <script type="text/javascript">
            (() => {
                ...
                window._translations = @json(app('Modules\Velocity\Helpers\Helper')->jsonTranslations());
            })();
        </script>
