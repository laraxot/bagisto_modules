...
use Modules\Checkout\Models\Cart as CartModel;
...
class Cart
{
     ...
     *
     * @var \Modules\Checkout\Repositories\CartAddressRepository
     */
     ...
     *
     * @var \Modules\Checkout\Repositories\ProductRepository
     */
     ...
     *
     * @var \Modules\Tax\Repositories\TaxCategoryRepository
     */
     ...
     * @param  \Modules\Checkout\Repositories\CartAddressRepository      $cartAddressRepository
     * @param  \Modules\Product\Repositories\ProductRepository           $productRepository
     * @param  \Modules\Tax\Repositories\TaxCategoryRepository           $taxCategoryRepository
     * @param  \Modules\Customer\Repositories\WishlistRepository         $wishlistRepository
     * @param  \Modules\Customer\Repositories\CustomerAddressRepository  $customerAddressRepository
     * @return void
     */
     ...
     *
     * @return \Modules\Customer\Contracts\Customer|bool
     */
     ...
     * @param array $data
     *
     * @return \Modules\Checkout\Contracts\Cart|string|array
     * @throws Exception
     */
     ...
     *
     * @param  array  $data
     * @return \Modules\Checkout\Contracts\Cart|null
     */
     ...
     *
     * @param  array  $data
     * @return \Modules\Checkout\Contracts\CartItem|void
     */
     ...
     * @return \Modules\Checkout\Contracts\Cart|null
     */
    public function getCart(): ?\Modules\Checkout\Contracts\Cart
    {
        $cart = null;
     ...
     * @return \Modules\Checkout\Contracts\CartPayment
     */
     ...
     */
    protected function setItemTaxToZero(\Modules\Checkout\Contracts\CartItem $item): \Modules\Checkout\Contracts\CartItem
    {
        $item->tax_percent = 0;
        $item->tax_amount = 0;
     ...
     *
     * @param \Modules\Checkout\Models\Cart|null $cart
     *
     * @return \Modules\Checkout\Models\Cart|null
     */
     ...
     *
     * @param  \Modules\Customer\Contracts\WishlistItem  $wishlistItem
     * @return bool
     */
     ...
     * @param \Modules\Checkout\Contracts\Cart $cart
     */
    private function assignCustomerFields(\Modules\Checkout\Contracts\Cart $cart): void
    {
        if ($this->getCurrentCustomer()->check()
     ...
     * Round cart totals
     *
     * @param \Modules\Checkout\Models\Cart $cart
     *
     * @return \Modules\Checkout\Models\Cart
     */
     ...
     * @return bool
     */
    private function isCartItemInactive(\Modules\Checkout\Contracts\CartItem $item): bool {
     ...
     * @return array
     */
    private function gatherBillingAddress($data, \Modules\Checkout\Models\Cart $cart): array
    {
        $customerAddress = [];
    ...
    /**
     * @param                            $data
     * @param \Modules\Checkout\Cart|null $cart
     *
     * @return array
     */
    private function gatherShippingAddress($data, \Modules\Checkout\Models\Cart $cart): array
    {
        $customerAddress = [];
    ...
    private function linkAddresses(
        \Modules\Checkout\Models\Cart $cart,
