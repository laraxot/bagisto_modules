...
class LocaleController extends Controller
{
    ...
    public function store()
    {
        $this->validate(request(), [
            'code'      => ['required', 'unique:locales,code', new \Modules\Core\Contracts\Validations\Code],
            'name'      => 'required',
    ...
    {
        $this->validate(request(), [
            'code'      => ['required', 'unique:locales,code,' . $id, new \Modules\Core\Contracts\Validations\Code],
            'name'      => 'required',
            'direction' => 'in:ltr,rtl',
        ]);
