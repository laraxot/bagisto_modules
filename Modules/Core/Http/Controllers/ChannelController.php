...
class ChannelController extends Controller
{
    ...
    public function store()
    {
        $data = $this->validate(request(), [
            /* general */
            'code'                  => ['required', 'unique:channels,code', new \Modules\Core\Contracts\Validations\Code],
            'name'                  => 'required',
    ...
    public function update($id)
    {
        ...
        $data = $this->validate(request(), [
            /* general */
            'code'                             => ['required', 'unique:channels,code,' . $id, new \Modules\Core\Contracts\Validations\Code],
