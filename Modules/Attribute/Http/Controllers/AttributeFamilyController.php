...
class AttributeFamilyController extends Controller
{
    ...
    public function store()
    {
        $this->validate(request(), [
            'code' => ['required', 'unique:attribute_families,code', new \Modules\Core\Contracts\Validations\Code],
            'name' => 'required',
        ]);
    ...
    {
        $this->validate(request(), [
            'code' => ['required', 'unique:attribute_families,code,' . $id, new \Modules\Core\Contracts\Validations\Code],
            'name' => 'required',
        ]);
